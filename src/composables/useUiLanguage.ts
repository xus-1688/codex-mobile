...
const zhCN: Record<string, string> = {
  ...
  'Search threads': '搜索线程',
  'Import local sessions': '导入本机会话',
  'Loading local sessions...': '正在加载本机会话...',
  'sessions available to import': '个可导入会话',
  'Search local sessions...': '搜索本机会话...',
  'Select all shown': '全选当前结果',
  'No local sessions found': '未找到本机会话',
  'All local sessions are already imported': '所有本机会话均已导入',
  'Show more': '显示更多',
  'Import': '导入',
  'Failed to load local sessions': '无法加载本机会话',
  'Filter threads...': '筛选线程...',
  'Clear search': '清除搜索',
  'Chats': '聊天',
  'Projects': '项目',
